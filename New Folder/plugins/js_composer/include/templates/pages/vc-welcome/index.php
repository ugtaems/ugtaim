<div class="wrap vc-page-welcome about-wrap">
	<h1><?php echo sprintf( __( 'wWw.Null24.IR-Welcome to Visual Composer %s', 'js_composer' ), preg_replace( '/^(\d+)(\.\d+)?(\.\d)?/', '$1$2', WPB_VC_VERSION ) ) ?></h1>

	<div class="about-text">
		<?php _e( 'wWw.Null24.IR-Congratulations! You are about to use most powerful time saver for WordPress ever - page builder plugin with Frontend and Backend editors by WPBakery.', 'js_composer' ) ?>
	</div>
